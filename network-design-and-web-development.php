...
<body class="has-navbar-fixed-top has-background-black-ter">
  ...
  <section class="section">
    ...
    With the rise of e-commerce, social media, and cloud-based applications, web development plays a vital role in shaping the digital landscape. It enables businesses to reach global audiences, provide online services, and innovate in an increasingly connected world.</p>
...
<<<<<<< Updated upstream:Network Design and Web Developemnt.php
...
=======
  ...
  <script src="/js/scripts.js"></script>
>>>>>>> Stashed changes:network-design-and-web-development.php
</body>
